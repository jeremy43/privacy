...
\begin{enumerate}
	...
	\begin{equation}
	  \beta = \argmin_\beta -\frac{1}{N_p} \sum_{x\in \text{Private}} \log( p( x\in \text{Private} | x \in \text{Private and Public}))}  \\- \frac{1}{N_s}\sum_{x \in \text{Public}} \log(p(x \in \text{Public} |\text{Public and Private}))
	\end{equation}
